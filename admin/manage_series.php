        ...
        <main class="admin-main-content">
            ...
            <section class="content-table-section">
                <div class="section-header">
                    <h2>All Series</h2>
                    <div>
                        <button id="addSeriesBtn" class="btn-add-new"><i class="fas fa-plus"></i> Add New
                            Series</button>
                        <button id="addEpisodeBtn" class="btn-add-new" style="margin-left: 10px;"><i
                                class="fas fa-upload"></i> Upload Episode</button>
                    </div>
                </div>
                        ...
                        if ($series_result && $series_result->num_rows > 0) {
                            while ($row = $series_result->fetch_assoc()):
                                ...
                                <tr>
                                    ...
                                    <td class="actions">
                                        <a href="#" class="edit-series" data-id="<?php echo $row['id']; ?>" title="Edit"><i
                                                class="fas fa-edit"></i></a>
                                        <a href="admin.php?delete_series=<?php echo $row['id']; ?>" class="delete"

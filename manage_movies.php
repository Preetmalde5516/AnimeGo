...
<body>
    ...
    <div class="admin-wrapper">
        ...
        <main class="admin-main-content">
            <div class="dashboard-header"><h1>Manage Movies</h1></div>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="actions">
                                ...
                                <a href="admin.php?delete_movie=<?php echo $row['id']; ?>" class="delete" title="Delete" onclick="return confirm('Are you sure?');"><i class="fas fa-trash"></i></a>
                            </td>
                        </tr>
                        <?php endwhile;
                        } else {
